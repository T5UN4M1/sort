...
export const Form = () => (
    <form method="post" action="#">
        ...
        <RadioField name="initial-numbers-configuration" id="almost-sorted" onChange={onChangeRadio} value="almost-sorted"/>
        <RadioField name="initial-numbers-configuration" id="inverted-sort" onChange={onChangeRadio} value="inverted-sort"/>
